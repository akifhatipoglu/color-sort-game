...
@SuppressLint("NewApi")
public class Activity_Level_Medium3 extends Activity implements OnTouchListener,
OnDragListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.medium3);
		...
		case DragEvent.ACTION_DROP:
			...
			if (pass == true) {
				...
				if (isGameFinished == 10) {
					...
					db.addScore("Level:Medium Section:4", PUAN);
					Intent intent = new Intent(Activity_Level_Medium3.this,
							Activity_Main.class);
					startActivity(intent);
					Activity_Level_Medium3.this.finish();
				}
			} else {
				owner.removeView(view);
