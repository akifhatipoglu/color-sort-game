...
@SuppressLint("NewApi")
public class Activity_Level_Hard extends Activity implements OnTouchListener,
		OnDragListener {
		...
		case DragEvent.ACTION_DROP:
			...
			if (pass == true) {
				...
				if (isGameFinished == 11) {
					...
					db.addScore("Level:Hard Section:1", PUAN);
					Intent intent = new Intent(Activity_Level_Hard.this,
							Activity_Main.class);
					startActivity(intent);
					Activity_Level_Hard.this.finish();
				}
			} else {
				owner.removeView(view);
