...
@SuppressLint("NewApi")
public class Activity_Level_Easy3 extends Activity implements OnTouchListener,
		OnDragListener {
		...
		case DragEvent.ACTION_DROP:
			...
			if (pass == true) {
				...
				if (isGameFinished == 6) {
					...
					db.addScore("Level:Easy Section:4", PUAN);
					Intent intent = new Intent(Activity_Level_Easy3.this,
							Activity_Main.class);
					startActivity(intent);
					Activity_Level_Easy3.this.finish();
				}
			} else {
				owner.removeView(view);
